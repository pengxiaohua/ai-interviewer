      ...
      <el-tab-pane label="面试记录列表" name="allOrderList">
        <div class="table-wrapper">
          <div class="search-area">
            ...
            <el-input
              placeholder="手机号"
              v-model="searchBO.mobile"
              prefix-icon="el-icon-mobile-phone"
              clearable
              style="width: 200px; margin-right: 10px; margin-bottom: 8px"
            ></el-input>
            <el-button type="primary" size="middle" @click="searchRecord()"
              >搜索</el-button
            >
          </div>

          <el-table
            :data="interviewerRecordList"
            border
            stripe
            class="table-list"
          >
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  size="mini"
                  plain
                  @click="showRecordDesc(scope.row.interviewRecordId)"
                  >查看详情</el-button
                >
              </template>
            </el-table-column>
        ...
        <el-dialog
          title=""
          :visible.sync="dialogRecordDescVisible"
          top="10vh"
          width="60%"
        >
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="dialogRecordDescVisible = false"
              >取 消</el-button
            >
            <el-button type="primary" @click="dialogRecordDescVisible = false"
              >确 定</el-button
            >
          </div>
        </el-dialog>
...
module.exports = {
  ...
  mounted() {
    this.initInterviewerRecordListList(
      1,
      this.interviewerRecordListPageInfo.pageSize
    );
  },
  methods: {
    formatSeconds(t) {
    ...
    gotoModifyCandidate(candidateId) {
      var targetPath =
        '/candidateMng/candidateCreate?candidateId=' + candidateId;
