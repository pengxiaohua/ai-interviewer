    ...
    <div class="userinfo-content-wrapper">
      ...
      >
        <img
          src="../../img/arrow.png"
          width="100px"
          style="border-radius: 50%; margin-top: 10px; align-self: center"
        />
        <div
          style="
            color: #000;
        ...
        <div style="font-size: 14px; align-self: center; margin-top: 2px">
      ...
      <div class="account-info-desc">
            ...
            <el-row :gutter="25">
              <el-col :span="10">
                <el-form-item label="性别">
                  <el-radio class="blank-left" v-model="form.sex" label="1"
                    >男</el-radio
                  >
        ...
        <!-- 下 -->
        <div class="account-info-down"></div>
      </div>
    </div>
  </div>
</template>
